  ...
  return (
    <section className="relative overflow-hidden bg-silk pt-28 pb-20 md:pt-36 md:pb-28">
      ...
      <div className="relative z-10 mx-auto w-full max-w-md px-6">
        <p className="micro mb-5 text-gilt">Akun</p>
        <h1 className="text-[2rem] leading-[1.08] md:text-[2.5rem]">Masuk</h1>
        <p className="mt-4 leading-relaxed text-plum-soft">
          Untuk melihat riwayat pesanan dan status pengiriman. Surel dari kami tidak pernah
          mencantumkan nama merek pada judulnya.
        </p>

        <form onSubmit={kirim} className="mt-10 space-y-7">
          <div>
            <label htmlFor="surel" className="micro mb-3 block text-plum-soft/60">
              Surel <span className="text-gilt">*</span>
            </label>
            <input
              id="surel"
              name="surel"
          ...
          <div>
            <label htmlFor="sandi" className="micro mb-3 block text-plum-soft/60">
              Kata sandi <span className="text-gilt">*</span>
            </label>
            <input
              id="sandi"
              name="sandi"
        ...
        <div className="mt-8 flex flex-col gap-3 border-t border-plum/12 pt-6">
          <Link href="/forgot" className="micro text-gilt hover:text-rose">
            Lupa kata sandi
          </Link>
          <Link href="/register" className="micro text-plum-soft hover:text-rose">
